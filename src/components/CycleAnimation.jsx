		...
		<>
			<div className="cycle_section">
				<div className="container">
					<div className="cycle_wrap">
						<svg width="512" height="512" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
							<g>
								<path d="M407.2 284.799L342.4 99.1992" stroke="white" stroke-width="16" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
								...
								<g className="left_wheel">
									<path d="M84.8 435.202C127.215 435.202 161.6 400.817 161.6 358.402C161.6 315.986 127.215 281.602 84.8 281.602C42.3845 281.602 8 315.986 8 358.402C8 400.817 42.3845 435.202 84.8 435.202Z" fill="black" stroke="white" stroke-width="16" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
